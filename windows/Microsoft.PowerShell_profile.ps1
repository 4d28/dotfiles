...
if (Get-Command 'oh-my-posh' -ErrorAction Ignore && Test-Path "$HOME/.omp/themes/4d28.omp.json") {
    oh-my-posh init pwsh --config "$HOME/.omp/themes/4d28.omp.json" | Invoke-Expression
}
